          ...
          <div className="h-[600px] border rounded-lg overflow-hidden flex flex-col">
            <div className="flex-1 overflow-auto bg-gray-100 flex items-center justify-center">
              <Document
                ...
                loading={<div className="text-gray-500">Chargement du PDF...</div>}
                error={<div className="text-red-500 p-4">Erreur: Le PDF n'a pas pu être chargé. Assurez-vous qu'il existe dans le dossier public.</div>}
              >
                <Page 
                  pageNumber={glpiPage} 
                  scale={glpiScale}
                  error={<div className="text-red-500">Erreur lors du chargement de la page</div>}
                />
              </Document>
            </div>
            <div className="flex justify-center items-center gap-2 p-2 bg-gray-50 border-t">
              ...
              <button
                onClick={() => setGlpiPage(p => Math.min(glpiTotalPages || p, p + 1))}
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="h-[600px] border rounded-lg overflow-hidden flex flex-col">
            ...
            <div className="flex justify-center items-center gap-2 p-2 bg-gray-50 border-t">
              ...
              <button
                onClick={() => setSshPage(p => Math.min(sshTotalPages || p, p + 1))}
